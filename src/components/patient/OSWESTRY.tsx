...
import { EPCProps as OSWProps, PatientPanel } from '../../interfaces';
...
async function postOSWAnswers(
  ...
  const response = await fetch(`${baseUrl}/api/v1/forms/patient/fill/OSWESTRY`, {
    method: 'POST',
    headers: {
...
export default function OSWESTRY(props: OSWProps) {
      ...
      {currentPanel === 0 && (
        <>
          <div className={classes.title}>
            ...
            Oswestry de Lombalgia
            </Typography>
          </div>
          <div className={classes.bodyContent}>
            <Typography variant="body1">
            Esse questionário avalia o impacto da dor nas costas em suas atividades diárias.
            </Typography>
            <Button
              variant="contained"
            ...
            Vigatto R, Alexandre NMC, Correa HR Filho. Development of a Brazilian Portuguese Version of the Oswestry DisabilitY. Index: Cross-Cultural Adaptation, Reability and Validity. Spine. 2007;32(4):481-6.
            </Typography>
          </div>
        </>
      )}
        ...
        <div className={classes.form}>
          ...
          {currentPanel === 1 && (
            <div>
              ...
              <Grid item xs={12}>
                <Typography variant="body1">
                  Selecione em cada seção, somente uma alternativa, a que se aplica ao seu caso.
                </Typography>
              </Grid>
              <Grid item xs={12}>
                <Typography variant="body2" className={classes.referenceInfo} >
                  (Nós entendemos que talvez você ache que duas das afirmações de uma seção podem estar relacionadas com seu caso, mas marque apenas a alternativa que melhor descreve o seu problema.)
                </Typography>
                </Grid>
              </Grid>
            </div>
